    ...
    public class StreamProcessors : IStreamProcessors
    {
            ...
            CancellationTokenSource cancellationTokenSource = default)
        {
            ...
            if (_streamProcessors.TryAdd(streamProcessor.Identifier, streamProcessor))
            {
                ...
                _logger.Debug($"Started Stream Processor with key '{new StreamProcessorId(eventProcessor.Identifier, sourceStreamId, sourceMicroservice)}' for tenant '{tenant}'");
        ...
        /// <inheritdoc/>
        public void Unregister(EventProcessorId eventProcessorId, StreamId sourceStreamId, Microservice sourceMicroservice)
        {
            var identifier = new StreamProcessorId(eventProcessorId, sourceStreamId, sourceMicroservice);
